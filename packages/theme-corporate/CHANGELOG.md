...
All notable changes to @keenmate/pure-admin-theme-corporate will be documented in this file.
...
### Fixed
- Dark mode navbar dropdown visibility (white text on dark background)
